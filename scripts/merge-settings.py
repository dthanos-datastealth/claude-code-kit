#!/usr/bin/env python3
"""DEPRECATED: shim that delegates to scripts/intelligent_settings_merge.py.
...
intelligent_settings_merge.py applies a per-key policy (defined in
...
shape; this shim forwards to intelligent_settings_merge.py + the default
...
def main() -> int:
    ...
    target = os.path.join(here, "intelligent_settings_merge.py")
